      ...
      <div className="container footer-inner">
        <div className="footer-brand">
          ...
          <a
            ...
            aria-label="Get Credzo on Google Play"
          >
            <svg className="footer-play-icon" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <span className="footer-play-text">
              <span className="footer-play-label">Get it on</span>
              <span className="footer-play-name">Google Play</span>
            </span>
          </a>
        </div>
        <div className="footer-links">
          ...
          <div className="footer-col">
            <p className="footer-col-label">Plans</p>
          ...
          <div className="footer-col">
            ...
            <a href="https://x.com/credzoapp" target="_blank" rel="noopener noreferrer" className="footer-social-link">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
